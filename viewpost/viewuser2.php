...
<head>
    ...
    <link rel="stylesheet" href="../viewpost/viewuser2.css">
...
<div class="dashboard-layout">
        ...
        <aside class="sidebar">
            ...
            <?php if (!empty($profile_link['pfpimg'])): ?>
                    <div class="profile-picture">
                        <img src="../dashboard/<?php echo htmlspecialchars($origin_profile_link); ?>" alt="Profile Picture" class="current-img" width="120px" height="120px">
                    </div>
            <?php else: ?>
                    <div class="profile-picture">
                        <img src="../viewpost/profile/user.png" alt="Profile Picture" class="current-img" width="120px" height="120px">
                    </div>
                <?php endif; ?>
        ...
        <div class="profile-picture">
            <img src="../dashboard/<?php echo !empty($user['pfpimg']) ? htmlspecialchars($user['pfpimg']) : 'profile/user.png'; ?>" alt="Profile Picture" style="width:150px; height:150px; object-fit: cover; border-radius: 50%;">
        </div>
        <div>
        <?php
